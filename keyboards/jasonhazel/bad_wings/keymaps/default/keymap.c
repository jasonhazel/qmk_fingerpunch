...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOUSE] = LAYOUT(
    ...
    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,          KC_NO,      KC_NO,    KC_NO,      KC_NO,     KC_NO,    \
    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,          KC_NO,      KC_NO,    KC_NO,      KC_NO,     KC_NO,    \
                            KC_MS_BTN1, TP_SCRL, KC_MS_BTN2,          KC_NO,      KC_NO,    KC_NO     
  )
};
bool trackpad_scrolling = false;

bool proccess_record_user(uint16_t keycode, keyrecord_t* record) {
  switch(keycode) {
    case TP_SCRL:
      trackpad_scrolling = record->event.pressed;
      return true;
      break;
    default:
      return true;
